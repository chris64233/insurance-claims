...
public record ReversePaymentRequest(
    ...
    public ReversePaymentRequest {
        reversedBy = reversedBy == null ? null : reversedBy.trim();
        if (reversedBy != null && reversedBy.isEmpty()) {
            reversedBy = null;
        }
        reverseReason = reverseReason == null ? null : reverseReason.trim();
        if (reverseReason != null && reverseReason.isEmpty()) {
            reverseReason = null;
        }
